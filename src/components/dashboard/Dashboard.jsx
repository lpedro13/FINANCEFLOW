...
const Dashboard = ({ selectedMonth, selectedYear, onMonthChange, onYearChange }) => {
  ...
  const dashboardData = useMemo(() => {
    ...
    const totalRevenueCurrentMonth = currentMonthTransactions.filter(t => t.type === 'receita').reduce((sum, t) => sum + t.amount, 0);
    const totalExpensesCurrentMonth = currentMonthTransactions.filter(t => t.type === 'despesa').reduce((sum, t) => sum + t.amount, 0);
    ...
    const cardChanges = {
        revenue: calculateChange(totalRevenueCurrentMonth, prevMonthRevenue),
        expenses: calculateChange(totalExpensesCurrentMonth, prevMonthExpenses),
        investments: "+0.0%", 
    };
    ...
    return {
      ...
      monthlyData: {
        ...
        expenses: totalExpensesCurrentMonth,
        balance: totalRevenueCurrentMonth - totalExpensesCurrentMonth + prevMonthBalance,
